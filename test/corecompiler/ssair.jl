...
@test repr(SlotNumber(23)) == ":(_23)"
@test repr(ReturnNode(23)) == ":(return 23)"
@test repr(ReturnNode(nothing)) == ":(return nothing)"
...
@test repr(enter_node) == "Core.EnterNode(11, #undef)"
@test enter_node.catch_dest == 11
@test !isdefined(enter_node, :scope)

argument = Argument(1)
@test sprint(Base.show_unquoted, argument) == "_1"
@test argument.n == 1
