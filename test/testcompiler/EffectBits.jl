...
using .CC: Effects, EFFECTS_TOTAL, EFFECTS_THROWS, EFFECTS_UNKNOWN, EFFECTS_MINIMAL
...
@test string(EFFECTS_UNKNOWN) == "(!c,!e,!re,!n,!t,!s,!m,!u,+o,!r)"
@test string(EFFECTS_MINIMAL) == "(!c,!e,!re,!n,!t,!s,!m,!u,!o,!r)"
@test +n in EFFECTS_TOTAL
@test !n in EFFECTS_THROWS
@test !c in EFFECTS_UNKNOWN

@test EFFECTS_TOTAL   == Effects(+c,+e,+re,+n,+t,+s,+m,+u,+o,+r)
@test EFFECTS_THROWS  == Effects(+c,+e,+re,!n,+t,+s,+m,+u,+o,+r) ==
                         Effects(+c,+e,+re,   +t,+s,+m,+u,+o,+r)
@test EFFECTS_UNKNOWN == Effects(!c,!e,!re,!n,!t,!s,!m,!u,+o,!r) ==
                         Effects(                         +o   )
...
@test sprint_plain(effects) == "(?c,!e,!re,!n,!t,!s,!m,!u,!o,!r)"
